...
// Internal = called only within the contract OR other contracts that inherit the smart contract (slightly less restrictive than public)
...
contract scope {
    //uint external data = 10; // state variable cannot be external
    uint public data = 10;
